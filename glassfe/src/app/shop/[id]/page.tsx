        ...
        <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-16">
            <div className="space-y-4">
              <div className="relative flex aspect-square items-center justify-center overflow-hidden rounded-lg border shadow-lg">
                  ...
                  >
                    <div className="flex h-full w-full items-center justify-center p-3 sm:p-4">
                      <Image
                        ...
                        width={600}
                        height={600}
                        className="mx-auto h-full max-h-[92%] w-full max-w-[92%] object-contain"
            ...
            <div>
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded bg-secondary/10 px-2 py-1 text-sm text-secondary-foreground">
                    {product.material}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <Button
                  size="lg"
                  className="flex w-full items-center gap-2 bg-gradient-to-r from-primary to-accent font-medium tracking-wide text-primary-foreground shadow-md shadow-primary/20 hover:from-primary/95 hover:to-accent/90"
                  onClick={() => setShowFaceModal(true)}
                >
                  <Camera className="h-5 w-5 shrink-0" />
                  AI thử kính theo dáng mặt
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-50/50 py-12 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <textarea
                className="w-full rounded-md border p-4 focus:outline-none focus:ring-2 focus:ring-primary"
                rows={4}
