              ...
              <div className="mt-3 space-y-1 rounded-[1.1rem] border border-white/10 bg-black/25 p-2.5 sm:p-3">
                ...
                {product.face_suitable &&
                  product.face_suitable.trim() !== "" && (
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-white">Phù hợp khuôn mặt:</span>
                ...
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-white">Thương hiệu:</span>
          ...
          <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <div className="mt-2 flex justify-end">
                <Button className="normal-case tracking-normal" onClick={handleReviewSubmit}>Gửi đánh giá</Button>
              </div>
            </div>
          </div>
        </div>
